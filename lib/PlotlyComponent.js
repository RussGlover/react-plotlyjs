  ...
  return _react2.default.createClass({
    ...
    componentDidUpdate: function componentDidUpdate(prevProps) {
      ...
      if (prevProps.data !== this.props.data) {
        ...
        var updateIndex = [];
        for (var i = 0; i < this.props.data[0].x.length; i++) {
          updateIndex[i] = i;
        }
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_extends, '_extends', 'src/PlotlyComponent.js');

  __REACT_HOT_LOADER__.register(_react2, '_react2', 'src/PlotlyComponent.js');

  __REACT_HOT_LOADER__.register(_lodash2, '_lodash2', 'src/PlotlyComponent.js');

  __REACT_HOT_LOADER__.register(_interopRequireDefault, '_interopRequireDefault', 'src/PlotlyComponent.js');

  __REACT_HOT_LOADER__.register(_objectWithoutProperties, '_objectWithoutProperties', 'src/PlotlyComponent.js');

  __REACT_HOT_LOADER__.register(createPlotlyComponent, 'createPlotlyComponent', 'src/PlotlyComponent.js');
}();
